...
void createMenu(void) {
	...
	glutAddMenuEntry("Modifica Pesi Vertici di Controllo", 1);
	...
	glutAddMenuEntry("Modifica Molteplicita' Nodi", 3);
	glutAddMenuEntry("Modifica Pesi Vertici di Controllo", 4);
